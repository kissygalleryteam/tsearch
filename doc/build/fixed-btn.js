...
kg/tsearch/2.0.0/common
kg/tsearch/2.0.0/trip-autocomplete
kg/tsearch/2.0.0/tradio
kg/tsearch/2.0.0/tsearch
kg/tsearch/2.0.0/hotel-search
kg/tsearch/2.0.0/index
kg/tsearch/2.0.0/template
kg/tsearch/2.0.0/fixed-btn

*/
/**
 * 旅行公共函数库
 */
KISSY.add('kg/tsearch/2.0.0/common',function (S){
    var Common = {
        /**
         * 截取指定长度的字符串
...
KISSY.add('kg/tsearch/2.0.0/trip-autocomplete',function (S, Ac , Common) {
    var ALIGH = {
        node    : null,
        points  : ['bl', 'tl'],
        overflow: {
...
}, {requires: ['kg/autocomplete/1.2/index' , './common', 'node' , 'event' , 'base']});
/**
 * RadioButton组件
 *
 * @module Radiobutton
 * @submodule
 **/
KISSY.add('kg/tsearch/2.0.0/tradio',function (S) {
    /**
     * Radiobutton
     * @class Radiobutton
     * @extends S.Base
 ...
 * @module tsearch
 **/
KISSY.add('kg/tsearch/2.0.0/tsearch',function (S,Base, TripAutocomplete ,Tradio , Calendar , Placeholder , LocalStorage , Common) {
    var Widgets = {
    ...
    return Tsearch;
}, {requires: ['base','./trip-autocomplete' , './tradio' , 'kg/calendar/1.2/index' , 'kg/placeholder/1.0/index' , 'kg/offline/2.0.0/index' ,'./common' , 'node', 'base']});
KISSY.add('kg/tsearch/2.0.0/hotel-search',function (S , Tsearch ,Common) {
...
KISSY.add('kg/tsearch/2.0.0/index',function (S , Tsearch , Thotelsearch){
    var global_cfg = {
...
KISSY.add('kg/tsearch/2.0.0/fixed-btn',function (S,O ,  TripSearch ,Template ,Slide) {
    ...
    return FixedSearch;
}, {requires: ['overlay', './index' ,'./template', 'kg/slide/2.0.0/index', 'node' , 'event' , 'base' , './fixed-btn.css']});
